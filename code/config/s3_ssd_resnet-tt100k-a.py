...
# Model
model_name                   = 'ssd_resnet50'          # Model to use: one of 'yolo' or 'tiny-yolo'
...
lrDecayScheduler_epochs      = range(1,11)    # List of epochs were decay is applied or None for all epochs
lrDecayScheduler_rate        = 0.9            # Decay rate (new_lr = lr / decay_rate). Usually between 2 and 10.
