...
# Model
model_name                   = 'ssd300_pretrained'          # Model to use: one of 'yolo' or 'tiny-yolo'
...
# Number of batches per epoch = 2620
...
LRScheduler_M                = 78600            # Number of iterations/epochs expected until convergence
